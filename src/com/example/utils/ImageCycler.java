...
public class ImageCycler extends LayerDrawable implements Drawable.Callback {
    ...
    public ImageCycler(Drawable[] drawables) {
        super(drawables);
        this.drawables = drawables;
    }
    
    public int getCurrentDrawableIndex(){
    	return currentDrawableIndex;
    }
